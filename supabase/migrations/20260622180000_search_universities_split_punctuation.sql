-- Recherche universités : découpage de la requête sur la ponctuation (tirets, slashs,
-- virgules…) en plus des espaces — pour que coller "FEN UChile - Universidad de Chile"
-- fonctionne. Match sur nom + ville + pays + acronymes + alias (accent-insensible).
